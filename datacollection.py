...
class WorkingFerryDiwanCollector:
    ...
    def collect_all_data_working(self):
        ...
        # Core indicators for institutional analysis
        indicators = {
            'RQ.EST': 'Regulatory_Quality',
            'PS.EST': 'Political_Stability',
            'DT.DOD.DECT.EX.ZS': 'Debt_to_Exports',
            'DT.TDS.DECT.EX.ZS': 'Debt_Service_to_Exports',
            'FP.CPI.TOTL.ZG': 'Inflation_CPI',
            'NY.GDP.PCAP.KD': 'GDP_per_Capita',
            'BN.CAB.XOKA.GD.ZS': 'Current_Account_Balance',
            'TT.PRI.MRCH.XD.WD': 'Terms_of_Trade',
            'FS.AST.DOMS.GD.ZS': 'Financial_depth',
        }
...
if __name__ == "__main__":
    ...
    if len(dataset) > 0:
        print(f"\n🎉 SUCCESS! You now have a working dataset for your Ferry & Diwan (2025) replication!")
